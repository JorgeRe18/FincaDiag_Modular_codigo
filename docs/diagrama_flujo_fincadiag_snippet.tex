% Pega esto en el preambulo de tu tesis si aun no lo tienes:
%
% \usepackage{xcolor}
% \usepackage{tikz}
...
\begin{figure}[htbp]
\centering
\begin{tikzpicture}[node distance=0.9cm and 1.2cm, transform shape, scale=0.92]
...
\end{tikzpicture}
\caption{Flujo general balanceado del instrumento FincaDiag Modular.}
